# ============================================================
# CONVERTER2 — verbatim in das generierte Script einfuegen
#
...
SKILL_DIR  = Path("/Users/robinwenzel/AI Playground/Claude Code/claude-code-skills/skills/slide2")
...
TEMPLATE_PATH = TPL_DIR / "mindsquare_Folienmaster.pptx"
...
def html_to_pptx(html_content: str, output_path: str) -> str:
    ...
    prs      = Presentation(TEMPLATE_PATH)   # Folienmaster als Basis
    blank_layout = prs.slide_layouts[3]      # Index 3 = "Leer" im Folienmaster
